					...
					<table width="1140px" border="0"  align="center">
						<tbody>
							...
							<tr>
                                ...
                                <form method="post" action="<?php echo base_url()."index.php/tampilan/edit"; ?>">
		                            <tr>
                                    <td>No. Produk </td>
                                    <td>:</td>
                                    ...
                                    <td>Gambar </td>
                                    <td>:</td>
                                    <td><input type="text" name="gam" readonly placeholder="Masukkan kode gambar" value="<?php echo $gambar;?>"></td>
                                    </tr>

                                    <tr>
                                    <td>Nama </td>
                                    <td>:</td>
                                    <td><input type="text" name="na" readonly placeholder="Masukkan nama obat" value="<?php echo $nama;?>"></td>
                                    </tr>

                                    <tr>
                                    <td>Deskripsi </td>
                                    <td>:</td>
                                    <td><input type="text" name="des" readonly placeholder="Masukkan deskripsi" value="<?php echo $deskripsi;?>"></td>
                                    </tr>
